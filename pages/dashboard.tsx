            ...
            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
              ...
              <div className="order-last flex w-full gap-x-8 text-sm font-semibold leading-6 sm:order-none sm:w-auto sm:border-l sm:border-gray-200 sm:pl-6 sm:leading-7">
                {secondaryNavigation.map((item) => (
                  <a key={item.name} href={item.href} className={item.current ? "text-tremor-brand" : "text-gray-700"}>
                    {item.name}
                  </a>
                ))}
              </div>
              <a
                href="#"
                className="ml-auto flex items-center gap-x-1 rounded-md bg-tremor-brand px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-tremor-brand-emphasis focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-tremor-brand"
              >
                              ...
                              <td className="py-5 text-right">
                                <div className="flex justify-end">
                                  <a
                                    ...
                                    className="text-sm font-medium leading-6 text-tremor-brand hover:text-tremor-brand-emphasis"
                                  >
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-sm font-semibold leading-6 text-tremor-brand hover:text-tremor-brand-emphasis"
                >
